// import type { SignupInput, SigninInput } from "@anikyet/mindcraft_common";
...
//   type InputType = typeof type extends "signup" ? SignupInput : SigninInput;
//   const [postInput, setPostInputs] = useState<InputType>(
//     (type === "signup"
//       ? { name: "", email: "", password: "" }
//       : { email: "", password: "" }) as InputType
//   );
